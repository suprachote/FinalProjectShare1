...
public class BluetoothArduino extends Thread {
    ...
    public static BluetoothArduino getInstance(String n){
        // __blue == null ? new BluetoothArduino(n) : __blue;
        __blue = new BluetoothArduino(n);
        return __blue;
    }
    ...
    private  BluetoothArduino(String Name){
        Log.d("Debug:","create new bluetooth");
        __blue = this;
        try {
            ...
            if (!isBluetoothEnabled()) {
                Log.d("Debug: ","bluetooth not enable");
